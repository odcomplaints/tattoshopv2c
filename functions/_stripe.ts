// Minimal, dependency-free Stripe REST client for the Cloudflare edge runtime.
//
// We talk to the Stripe API directly with `fetch` instead of the Node SDK so the
// code runs on Cloudflare Pages Functions (Workers runtime) without any bundling,
// polyfill, or Node-builtin concerns.
