...
export default function EvilEye({
  ...
  useEffect(() => {
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        ...
        uPupilColor: { value: hexToVec3(pupilColor) },
  ...
  }, [eyeColor, intensity, pupilSize, irisWidth, glowIntensity, scale, noiseScale, pupilFollow, flameSpeed, pupilColor, backgroundColor])
