...
export const catalog: Record<string, CatalogEntry> = {
  'bape-shark-glow': { id: 'bape-shark-glow', name: 'Bape Shark Glow in the Dark', priceCents: 34000, currency: 'eur', available: true },
  'bape-shark-lila': { id: 'bape-shark-lila', name: 'Bape Shark Hoodie Lila', priceCents: 39000, currency: 'eur', available: true },
  ...
  'bape-shark-pink': { id: 'bape-shark-pink', name: 'Bape Shark Hoodie Pink', priceCents: 36000, currency: 'eur', available: true },
  'bape-shark-rot': { id: 'bape-shark-rot', name: 'Bape Shark Hoodie Rot', priceCents: 36000, currency: 'eur', available: true },
  ...
  'balenciaga-sweatjacke': { id: 'balenciaga-sweatjacke', name: 'Balenciaga Sweatjacke', priceCents: 59000, currency: 'eur', available: true },
  'corteiz-hoodie': { id: 'corteiz-hoodie', name: 'Corteiz Hoodie', priceCents: 24000, currency: 'eur', available: true },
  ...
  'carlo-colucci-1': { id: 'carlo-colucci-1', name: 'Carlo Colucci Strickjacke I', priceCents: 21000, currency: 'eur', available: true },
  'carlo-colucci-2': { id: 'carlo-colucci-2', name: 'Carlo Colucci Strickjacke II', priceCents: 21000, currency: 'eur', available: true },
  'spider-hoodie-pink': { id: 'spider-hoodie-pink', name: 'Spider Hoodie Pink', priceCents: 28000, currency: 'eur', available: true },
