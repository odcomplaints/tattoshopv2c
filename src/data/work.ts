...
export const work: Work[] = [
  ...
  { title: 'Trace', date: new Date('2026-02-14'), style: 'Abstract', bodyPart: 'Ribs', image: '/assets/work/5.png' },
  { title: 'Field Notes', date: new Date('2026-01-25'), style: 'Fineline', bodyPart: 'Forearm', image: '/assets/work/6.png' },
