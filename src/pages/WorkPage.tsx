  ...
  return (
    <Layout title="Work | OD: COMPLAINTS" description="A selection of recent blackwork, fineline and botanical tattoos by OD: COMPLAINTS.">
      <section className="text-center">
        <p className="text-xs uppercase tracking-widest text-neutral-500">Archive</p>
      ...
      <section className="mt-12 text-center sm:mt-16"><WorkGrid items={newestWork} /></section>
    </Layout>
  )
}